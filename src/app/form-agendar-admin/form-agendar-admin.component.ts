...
@Component({
  selector: 'app-form-agendar-admin',
  templateUrl: './form-agendar-admin.component.html',
  styleUrl: './form-agendar-admin.component.css'
})
export class FormAgendarAdminComponent {
  @Input() btnText: any;
