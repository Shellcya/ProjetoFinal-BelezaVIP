package com.springboot.projetofinalacademiaufnbelezavip.infra.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity.cors().and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/agendamento/cpf").permitAll()
                        .requestMatchers(HttpMethod.POST, "/cadastro").permitAll()
                        .requestMatchers(HttpMethod.GET, "/cadastro/cpf").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/cadastro/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/cadastro/{id}/{campo}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/cadastro").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/cadastro/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/agendamento/{id}").permitAll()
